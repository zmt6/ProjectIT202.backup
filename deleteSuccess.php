<?php
  ...
  $id = $_SESSION['id'];  
        ...
        $delete_query="DROP TABLE $appointmentTable";
        $stmt = $db->prepare($delete_query);
        $r = $stmt->execute();
        
        $delete_query="DELETE FROM projectAccounts WHERE id = '$id'";
        $stmt = $db->prepare($delete_query);
        $r = $stmt->execute();
...
<html>
	<head>
		<title> Dog Kennel | Success </title>
		<meta charset="utf-8" />
...
<nav>
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Scedule Appointment -->
							<article id="scedule">
								<h2 class="major"> Scedule Appointment </h2>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy; Zach Tenten. Design: <a href="https://html5up.net">HTML5 UP</a>.</p>
					</footer>
